...
messages = [
    ...
    Example: if the problem is about cans of soup and the final answer ended up as 2.5 cans or 10.25 or 1.75 cans etc. then round them up to nearest integer.
    """),
